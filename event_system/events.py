...
def create_event(event_name, event_date, event_time, venue, total_slots):
    ...
    Args:
        ...
        event_time (str): The time of the event (e.g., '10:00 AM').
...
def get_all_events():
    ...
    Returns:
        list: A list of tuples, where each tuple represents an event
              (event_id, event_name, event_date, event_time, venue, total_slots).
...
def get_event_details(event_id):
    ...
    Returns:
        tuple: A tuple representing the event (event_id, event_name, event_date, event_time, venue, total_slots)
